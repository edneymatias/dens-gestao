...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Default middleware that will be applied to Filament routes. We add
    | the `EnsureSuperAdmin` middleware to protect the landlord panel so
    | only super-admin users can access it.
    |
    */
